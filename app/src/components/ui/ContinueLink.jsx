...
export default function ContinueLink({ children = 'Continue', onClick, delay = 0 }) {
  return (
    <motion.button
      ...
      whileHover="hover"
      className="group relative inline-flex items-center gap-2 pb-1 font-body text-[0.7rem]
                 uppercase tracking-[0.32em] text-ivory/55 transition-colors duration-300
                 hover:text-gold"
    >
      <span>{children}</span>
      <motion.span
